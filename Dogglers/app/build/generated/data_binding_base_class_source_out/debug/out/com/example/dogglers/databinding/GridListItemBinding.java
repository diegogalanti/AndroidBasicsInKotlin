...
public final class GridListItemBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView dogHoobies;
  ...
  public static GridListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.dog_hoobies;
      TextView dogHoobies = ViewBindings.findChildViewById(rootView, id);
      if (dogHoobies == null) {
        break missingId;
      }
      ...
      return new GridListItemBinding((MaterialCardView) rootView, dogAge, dogHoobies, dogImage,
          dogName);
    }
